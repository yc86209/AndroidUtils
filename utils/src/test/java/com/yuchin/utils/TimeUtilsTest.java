...
import com.yuchin.utils.util.TimeUtils;
...
public class TimeUtilsTest {
    ...
    private final long delta = 5;// 允許誤差5ms
    ...
    public void getFitTimeSpan() throws Exception {
        ...
        String testTimeStringFormat = TimeUtils.millis2String(testTimeMillis, mFormat);
        Date testTimeDate = TimeUtils.millis2Date(testTimeMillis);
        assertEquals("10天10分鐘10秒", TimeUtils.getFitTimeSpan(timeString, testTimeString, 5));
        assertEquals("10天10分鐘10秒", TimeUtils.getFitTimeSpan(timeStringFormat, testTimeStringFormat, mFormat, 5));
        assertEquals("10天10分鐘10秒", TimeUtils.getFitTimeSpan(timeDate, testTimeDate, 5));
        assertEquals("10天10分鐘10秒", TimeUtils.getFitTimeSpan(timeMillis, testTimeMillis, 5));
    }
    ...
    public void getFitTimeSpanByNow() throws Exception {
        ...
        assertEquals("6天6小時6分鐘6秒", TimeUtils.getFitTimeSpanByNow(TimeUtils.millis2String(System.currentTimeMillis() + spanMillis), 4));
        assertEquals("6天6小時6分鐘6秒", TimeUtils.getFitTimeSpanByNow(TimeUtils.millis2String(System.currentTimeMillis() + spanMillis, mFormat), mFormat, 4));
        assertEquals("6天6小時6分鐘6秒", TimeUtils.getFitTimeSpanByNow(TimeUtils.millis2Date(System.currentTimeMillis() + spanMillis), 4));
        assertEquals("6天6小時6分鐘6秒", TimeUtils.getFitTimeSpanByNow(System.currentTimeMillis() + spanMillis, 4));
    }

    @Test
    public void getFriendlyTimeSpanByNow() throws Exception {
        assertEquals("剛剛", TimeUtils.getFriendlyTimeSpanByNow(TimeUtils.getNowString()));
        assertEquals("剛剛", TimeUtils.getFriendlyTimeSpanByNow(TimeUtils.getNowString(mFormat), mFormat));
        assertEquals("剛剛", TimeUtils.getFriendlyTimeSpanByNow(TimeUtils.getNowDate()));
        assertEquals("剛剛", TimeUtils.getFriendlyTimeSpanByNow(TimeUtils.getNowMills()));
        assertEquals("1秒前", TimeUtils.getFriendlyTimeSpanByNow(TimeUtils.getNowMills() - TimeConstants.SEC));
        assertEquals("1分鐘前", TimeUtils.getFriendlyTimeSpanByNow(TimeUtils.getNowMills() - TimeConstants.MIN));
    }
    ...
    public void getChineseZodiac() throws Exception {
        assertEquals("雞", TimeUtils.getChineseZodiac(timeString));
        assertEquals("雞", TimeUtils.getChineseZodiac(timeStringFormat, mFormat));
        assertEquals("雞", TimeUtils.getChineseZodiac(timeDate));
        assertEquals("雞", TimeUtils.getChineseZodiac(timeMillis));
        assertEquals("雞", TimeUtils.getChineseZodiac(2017));
    }
    ...
    public void getZodiac() throws Exception {
        ...
        assertEquals("獅子座", TimeUtils.getZodiac(8, 16));
    }
}