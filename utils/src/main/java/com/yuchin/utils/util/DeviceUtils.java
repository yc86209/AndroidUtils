...
public final class DeviceUtils {
    ...
    /**
     * 獲取設備 MAC 地址
     * <p>需添加權限 {@code <uses-permission android:name="android.permission.ACCESS_WIFI_STATE" />}</p>
    ...
    /**
     * 關機
     * <p>需要 root 權限或者系統權限 {@code <android:sharedUserId="android.uid.system" />}</p>
     */
    ...
    /**
     * 重啟
     * <p>需系統權限 {@code <android:sharedUserId="android.uid.system" />}</p>
     *
