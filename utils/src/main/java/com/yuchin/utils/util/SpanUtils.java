...
public final class SpanUtils {
    ...
    /**
     * 設置行高
     * <p>當行高大於字體高度時，字體在行中的位置由{@code align}決定</p>
     *
     * @param lineHeight 行高
     * @param align      對齊
     *                   <ul>
     ...
     * <p>默認 0 邊距，居中對齊</p>
     *
     * @param resourceId 圖標 resourceId
     * @return {@link SpanUtils}
     */
    ...
    /**
     * 設置模糊
     * <p>尚存 bug，其他地方存在相同的字體的話，相同字體出現在之前的話那麽就不會模糊，出現在之後的話那會一起模糊</p>
     * <p>以上 bug 關閉硬件加速即可</p>
     *
     * @param radius 模糊半徑（需大於 0）
     * @param style  模糊樣式<ul>
    ...
    class CustomIconMarginSpan
        ...
        private Bitmap resource2Bitmap(final int resourceId) {
            ...
            drawable.setBounds(0, 0, drawable != null ? drawable.getIntrinsicWidth() : 0, drawable != null ? drawable.getIntrinsicHeight() : 0);
            drawable.draw(canvas);
            return bitmap;
        }
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    ...
                    drawable.setBounds(
                            0, 0, drawable != null ? drawable.getIntrinsicWidth() : 0, drawable != null ? drawable.getIntrinsicHeight() : 0
                    );
                } catch (Exception e) {
